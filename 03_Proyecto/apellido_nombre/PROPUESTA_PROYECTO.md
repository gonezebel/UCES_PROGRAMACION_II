...
El proyecto consiste en desarrollar un sistema de gestion de turnos para un hospital o centro de salud. El sistema permitira registrar pacientes y profesionales, crear agendas de atencion, asignar y anular turnos, y enviar recordatorios de consultas. El tema surge del material trabajado en [00_Boceto_POO](c:\Users\Administrador\Documents\UCES_PROGRAMACION_II\00_Boceto_POO), donde se definieron como funciones principales el registro de pacientes y profesionales, la asignacion de turnos, la anulacion de turnos y el envio de recordatorios.
...
Representa un turno asignado a un paciente con un profesional.
...
Representa un recordatorio o aviso del sistema.
...
En el proyecto se sobreescriben varios metodos heredados. Se cumplen ampliamente los 2 metodos minimos requeridos:
...
El documento en PDF debera ir acompañado por un archivo comprimido `.zip` o `.rar` con una copia completa del proyecto en Java. En este caso, la carpeta a comprimir sera `apellido_nombre`, respetando los nombres de paquetes y el archivo principal solicitados en la consigna.
